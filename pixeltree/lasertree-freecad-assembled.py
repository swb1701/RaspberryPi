...
tree1=face1.extrude(Base.Vector(0,0,thickness))
tree1.rotate(Base.Vector(baseWidth/2,50+treeHeight/2,0),Base.Vector(1,0,0),180)
tree1.rotate(Base.Vector(baseWidth/2,50+treeHeight/2,0),Base.Vector(0,1,0),90)
tree1.translate(Base.Vector(baseWidth*0.6+thickness/2,0,0))
doc=FreeCAD.newDocument()
obj=doc.addObject("Part::Feature","Tree1")
obj.Shape=tree1
...
tree2=face2.extrude(Base.Vector(0,0,thickness))
obj=doc.addObject("Part::Feature","Tree2")
obj.Shape=tree2
obj.ViewObject.ShapeColor=(0.0,1.0,0.0)
obj.ViewObject.Transparency=10
